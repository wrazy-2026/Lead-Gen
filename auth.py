...
class User(UserMixin):
    ...
    def _get_users_ref():
        ...
        try:
            ...
            return firestore.client(database_id=firestore_db_id if firestore_db_id else None).collection('users')
    ...
    def create_or_update(email, name, picture=None):
        ...
        super_admins = [ADMIN_EMAIL.lower(), 'wrazyfortowing@gmail.com', 'lsperry21@gmail.com']
        is_admin = email.lower() in super_admins
        from datetime import datetime
        import time
        import re
