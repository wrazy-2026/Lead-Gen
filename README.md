...
- **SOS Business Scraper** - Interactive scraper with filters (Status, Category, State), filtered exports. **⚠️ FL only** (all 27 states tested - selectors outdated, needs fixing)
